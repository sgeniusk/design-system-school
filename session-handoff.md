...
## What just shipped (Phase 6·7·8 push 완료 + Phase 9 워킹 트리)
...
- **Phase 9** (커밋 대기) — `scripts/extract-design-spec.ts`: fetch + meta·색·폰트 추출 + AnalysisDesignSpec TS 객체 직렬화. TODO 마커로 사람 검수 부분 표시. `scripts/README.md`에 자동/수동 경계 표 + 신규 analysis 추가 흐름.
